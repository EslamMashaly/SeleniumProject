...
public class SignUpPage extends BasePage {
    ...
    private By confirmPasswordField=By.xpath("//input[contains(@class,'confirm-password')]");
    private By passwordStrengthText=By.id("password-strength-text");
    private By continueButton2=By.xpath("//button[@class='mdc-button mdc-button--touch mdc-button--raised to-personal-details mdc-ripple-upgraded']");
    private By unMatchedPasswordsMessage=By.id("confirm-password-label");
